...
class PlayerPerGame {
    var playerSeasonPerGameID: Int64?
    ...
    init(playerSeasonPerGameID: Int64, playerName: String, Season: String, Age: String, Tm: String,
    ...
    {
        self.playerSeasonPerGameID = playerSeasonPerGameID
